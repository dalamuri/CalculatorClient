...
<jsp:useBean id="sampleCalculatorProxyid" scope="session" class="com.egiants.ws.CalculatorProxy" />
<%
...
case 10:
        gotMethod = true;
        com.egiants.ws.Calculator getCalculator10mtemp = sampleCalculatorProxyid.getCalculator();
