...
public class CalculatorProxy implements com.egiants.ws.Calculator {
  private String _endpoint = null;
  private com.egiants.ws.Calculator calculator = null;
  ...
  private void _initCalculatorProxy() {
    try {
      calculator = (new com.egiants.ws.CalculatorServiceLocator()).getCalculator();
      if (calculator != null) {
        if (_endpoint != null)
  ...
  public com.egiants.ws.Calculator getCalculator() {
    if (calculator == null)
      _initCalculatorProxy();
    return calculator;
  }
