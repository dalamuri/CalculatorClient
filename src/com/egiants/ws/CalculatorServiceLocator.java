...
package com.egiants.ws;

public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.egiants.ws.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://localhost:8027/Calculator/services/Calculator";
    ...
    public com.egiants.ws.Calculator getCalculator() throws javax.xml.rpc.ServiceException {
    ...
    public com.egiants.ws.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.egiants.ws.CalculatorSoapBindingStub _stub = new com.egiants.ws.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.egiants.ws.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.egiants.ws.CalculatorSoapBindingStub _stub = new com.egiants.ws.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://ws.egiants.com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://ws.egiants.com", "Calculator"));
        }
